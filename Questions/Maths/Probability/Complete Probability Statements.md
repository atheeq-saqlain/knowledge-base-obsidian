...
| ----- | -----: | :------: | ---- |
| Complete P(E) + P(not E) = 1 ([[Complementary Events]]) | 2 | true | primary |
| State impossible (0) and sure/certain (1) events | 2 | true | primary |
| State sum of elementary events is 1 and 0 ≤ P(E) ≤ 1 | 2 | true | primary |
